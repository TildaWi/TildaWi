...
- **1) 비즈니스 데이터 분석**: 운영 효율화와 프로세스 개선 중심의 데이터 인사이트 도출 분석([바로가기](https://github.com/your-id/tableau-dashboard))

- **2) 프로덕트 데이터 분석**: 유저 퍼널·이탈 분석, A/B 테스트 설계 및 검증, 유저 여정(behavior flow) 분석([바로가기](https://github.com/your-id/tableau-dashboard))  
